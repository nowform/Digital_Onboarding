...
function activateCard(){
    ...
    document.querySelector('#body-not-activated-step2').classList.add('hidden');
    document.querySelector('#body-activated-step2').classList.remove('hidden');
...
function swicthToUpdateEmail(){
    document.querySelector('#body-before-subscription-step2').classList.add('hidden');
    document.querySelector('#body-after-subscription-step2').classList.add('hidden');
    document.querySelector('#body-update-email-step2').classList.remove('hidden');

    document.querySelector('#body-before-subscription-step3').classList.add('hidden');
    document.querySelector('#body-after-subscription-step3').classList.add('hidden');
    document.querySelector('#body-update-email-step3').classList.remove('hidden');

    document.querySelector('#body-before-subscription-step4').classList.add('hidden');
    document.querySelector('#body-after-subscription-step4').classList.add('hidden');
    document.querySelector('#body-update-email-step4').classList.remove('hidden');
...
function emailUpdated(){
    document.querySelector('#body-before-subscription-step2').classList.add('hidden');
    document.querySelector('#body-after-subscription-step2').classList.add('hidden');
    document.querySelector('#body-update-email-step2').classList.add('hidden');   
    document.querySelector('#body-after-update-email-step2').classList.remove('hidden');
    changeStep('4');   
}
...
function set3Subscribe(){
    document.querySelector('#body-before-subscription-step3').classList.add('hidden');
    document.querySelector('#body-after-subscription-step3').classList.remove('hidden');
    // window.location.hash = '';
    changeStep('4'); 
}
function set4Subscribe(){
    document.querySelector('#body-before-subscription-step4').classList.add('hidden');
    document.querySelector('#body-after-subscription-step4').classList.remove('hidden');
    // window.location.hash = '';
    changeStep('4'); 
}
function verifyEsub(){
    document.querySelector('#body-before-subscription-step2').classList.add('hidden');
    document.querySelector('#body-after-subscription-step2').classList.remove('hidden');
    window.location.hash = '';
    changeStep('4'); 
}
